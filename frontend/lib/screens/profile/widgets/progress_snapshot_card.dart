...
/// - When numeric props ([workoutsCount], [streakDays], [adherencePercent]) or explicit string values
///   ([workoutsValue], [streakValue], [adherenceValue]) are missing or `null`, values fallback to
///   an em-dash ('—') without displaying fake or invented metrics.
/// - When [onViewProgressTap] is `null`, the footer link displays "View progress · Coming soon" as a disabled text state.
