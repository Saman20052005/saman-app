...
class ActiveWorkoutScreen extends ConsumerStatefulWidget {
  ...
  /// Backwards-compatible entry: existing call sites currently pass `List<Exercise>`.
  /// We convert it to a `domain.WorkoutPlan` so we can keep the richer workout flow.
  factory ActiveWorkoutScreen.fromExercises({
    ...
    final converted = domain.WorkoutPlan(
      title: title,
      category: 'Custom',
      level: 'Custom',
      duration: 0,
    ...
    return ActiveWorkoutScreen(
        key: key, workoutPlan: converted, heroTag: heroTag);
  }
...
class _ActiveWorkoutScreenState extends ConsumerState<ActiveWorkoutScreen> {
  ...
  void _initSets() {
    ...
    for (int i = 0; i < exercises.length; i++) {
      final count = exercises[i].setCount;
  ...
  Widget _buildExerciseCard(int index, domain.WorkoutExercise exercise) {
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${exercise.setCount} Sets • ${exercise.reps}',
                        style: TextStyle(
                      ...
                      return GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: isDone ? _neonGreen : Colors.grey.shade700,
                            ),
                          ),
                          child: Center(
                            child: isDone
