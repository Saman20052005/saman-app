...
void main() {
  testWidgets(
      'Capture visual render of State 10 Full-Height Drawer at 390x844',
      (tester) async {
    ...
    const outputPath =
        '/Users/saman/.gemini/antigravity-ide/brain/3f6beed2-836f-4f92-acf2-501da675c85b/saman_chat_state_10_drawer_render.png';
    ...
    // Tap the menu icon in SamanChatHeader to open drawer
    final menuButton = find.byTooltip('Coach Menu');
