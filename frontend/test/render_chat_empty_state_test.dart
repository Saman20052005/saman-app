...
class _FakeChatNotifier extends StateNotifier<ChatState>
  ...
  _FakeChatNotifier() : super(ChatState(messages: []));
...
void main() {
  testWidgets('Capture visual render of Saman Chat Empty State at 390x844',
      (tester) async {
    ...
    const outputPath =
        '/Users/saman/.gemini/antigravity-ide/brain/3f6beed2-836f-4f92-acf2-501da675c85b/saman_chat_empty_state_render.png';
